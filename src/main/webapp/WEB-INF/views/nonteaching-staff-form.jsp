...
<head>
    ...
    <title>Non Teaching Staff Issue Form</title>
    <link rel="stylesheet" href="<c:url value='/resources/css/book-form.css' />">
</head>
<body>
    <div class="login-container">
        <h2><i class="fas fa-laptop-code"></i> Non Teaching Staff Medical Issue</h2>
        <form:form action="process-nonteaching-faculty-form" modelAttribute="staffIssue">
