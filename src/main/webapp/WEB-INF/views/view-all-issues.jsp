...
<head>
    ...
    <link rel="stylesheet" href="<c:url value='/resources/css/view-all-issues.css' />">
</head>
<body>
    <div class="container">
        <h1><i class="fas fa-clipboard-list"></i> Complaints Dashboard</h1>
            ...
            <table>
                ...
                <tbody>
                    <c:choose>
                        <c:when test="${not empty students || not empty faculty || not empty staff}">
                            <c:forEach items="${students}" var="student">
                                <tr>
                                    ...
                                    <td data-label="Status">
                                        <span class="status-badge status-ongoing">Student</span>
                                    </td>
                                </tr>
                            </c:forEach>
                            <c:forEach items="${faculty}" var="faculty">
                                <tr>
                                    ...
                                    <td data-label="Status">
                                        <span class="status-badge status-completed">Faculty</span>
                                    </td>
                                </tr>
                            </c:forEach>
                            <c:forEach items="${staff}" var="staff">
                                <tr>
                                    ...
                                    <td data-label="Status">
                                        <span class="status-badge status-due">Staff</span>
                                    </td>
                                </tr>
                            </c:forEach>
                        </c:when>
                        <c:otherwise>
                            <tr>
                                <td colspan="7" class="no-complaints">No Complaints</td>
                            </tr>
                        </c:otherwise>
                    </c:choose>
                </tbody>
