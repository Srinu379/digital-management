...
<body>
    <div class="container">
        ...
        <form:form action="process-register" modelAttribute="userRegistration" onsubmit="return validate()">
            ...
            <div class="form-group">
                <form:password path="passWord" id="passWord" class="form-input" placeholder="Confirm Password"/>
            ...
            <div class="form-group">
                <form:input path="otp" type="number" id="otp" class="form-input" placeholder="otp"/>
